	 ...
	 */
	 ...
	 public void update_rating()
	 {
		 ...
		 try {
			 ...
			 if(rs2.next())
			 {
				 prev_rating = rs2.getString(3);
				 prev_trips = rs2.getString(8);
	 ...
	 public Rating_Driver() {
		 ...
		 driv_name = new JLabel("Name of the Driver");
		 ...
		 JLabel lblThankYouFor = new JLabel(" Thank You For Choosing Kr Ride 💐💐");
